...
const requesti = require('../network')
...
async function transferCrypto(to, amount, currency, ref, req, res, extraId = 0) {
    try {
        ...
        // let fee = Number(String(await web3.eth.getGasPrice()))*21000
...
//     console.log("PEnding:",pendingBalance, availableBalance, ethBalance)
